...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeStop(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeSendTouch(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeSendTouchFrame(
    JNIEnv *env, jobject thiz)
{
    if (!g_state.ctx)
        return;
...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeSendKey(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeSendMouseMotion(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeSendMouseButton(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_MainActivity_nativeSendMouseScroll(
