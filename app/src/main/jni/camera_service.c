...
Java_com_anland_termux_CameraServices_nativeInitCameraService(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_CameraServices_nativeDestroyCameraService(
...
Java_com_anland_termux_CameraServices_nativeGetSlotBuffer(
...
Java_com_anland_termux_CameraServices_nativeAwaitSlotFree(
...
JNIEXPORT void JNICALL
Java_com_anland_termux_CameraServices_nativeFrameReady(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_anland_termux_CameraServices_nativePackFrame(
    JNIEnv *env, jobject thiz, jint cam, jint slot,
...
int camera_service_init(JNIEnv *env, jobject activity_obj)
{
    ...
    jclass cls = (*env)->FindClass(env, "com/anland/termux/CameraServices");
    if (!cls) {
